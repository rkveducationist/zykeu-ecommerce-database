...
--
-- Host: localhost    Database: zykeucommercedb
-- ------------------------------------------------------
...
CREATE TABLE `order_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK62hhky7l17n247dcydumefagb` (`order_id`),
  CONSTRAINT `FK62hhky7l17n247dcydumefagb` FOREIGN KEY (`order_id`) REFERENCES `orders_table` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-12 11:15:33
